...
import org.firstinspires.ftc.teamcode.OpModes.Tests.PropPlace;
...
public class SimpleOpMode extends LinearOpMode {
    ...
    public enum StartPosition{
        ...
        public boolean isLeft(SimpleOpMode.StartPosition startPosition) {
            if(startPosition == FRONTLEFT || startPosition == BACKLEFT)
                return true;
            return false;
        }

        public boolean isFront(SimpleOpMode.StartPosition startPosition) {
    ...
    public static void absoluteAutonumus(SimpleOpMode.StartPosition startPosition, LinearOpMode linearOpMode)
    {
    ...
    public void runOpMode() throws InterruptedException{
       absoluteAutonumus(StartPosition.FRONTLEFT);
    }
}
